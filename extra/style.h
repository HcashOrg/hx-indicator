...
#define OKBTN_STYLE     "QToolButton{font: 14px \"微软雅黑 Light\";background-color: rgb(84,116,235);border:0px solid white;border-radius:15px;color: white;}"  \
...
#define TOOLBUTTON_STYLE_1      "QToolButton{font: 11px \"微软雅黑 Light\";background-color:#00D2FF; border:none;border-radius:10px;color: rgb(255, 255, 255);}" \
...
#define TABLEWIDGET_STYLE_1     "QTableView{background-color:white;border:1px solid rgb(236,238,251);border-radius:15px;}" \
                                "QHeaderView{border:none;border-top-left-radius:15px;border-top-right-radius:15px;background-color:white;color:#C6CAD4;font: 12px \"微软雅黑 Light\";}" \
...
#define SELECTBTN_STYLE "QToolButton{background:transparent;color:rgb(192,202,212);font: 11px \"微软雅黑 Light\";}" \
