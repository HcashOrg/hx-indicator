...
#define OKBTN_STYLE     "QToolButton{font: 14px \"Microsoft YaHei UI Light\";background-color: rgb(84,61,137);border:0px solid white;border-radius:3px;color: white;}"  \
                        "QToolButton:pressed{background-color:rgb(84,61,137);}"\
                        "QToolButton:disabled{background-color:rgb(196,191,214);}"

#define CANCELBTN_STYLE "QToolButton{font: 14px \"Microsoft YaHei UI Light\";background:rgb(235,0,94);color: rgb(255,255,255);border:0px solid rgb(84,116,235);border-radius:3px;}"  \
